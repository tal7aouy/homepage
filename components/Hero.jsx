			...
			<div className='flex items-center justify-center md:flex-row flex-col'>
				...
				<div className='ml-0 md:ml-16'>
					...
					<h1 className='text-2xl font-normal leading-10'>
						...
						{
							'I am a proficient Mid-level PHP-Laravel developer with +2 years of experience.'
						}
						<span className='mt-5 block'>
							 I have proven expertise in easing development pains like routing, authentication, sessions and caching, and web app development through Laravel Framework
						</span>
					</h1>
				</div>
			</div>
